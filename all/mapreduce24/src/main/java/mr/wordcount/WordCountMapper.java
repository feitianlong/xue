...
/**
 * KEYIN ：是map task读取到的数据的key的类型，是一行的起始偏移量Long VALUEIN:是map
 * task读取到的数据的value的类型，是一行的内容String
 * 
 ...
 * 
 * hadoop为jdk中的常用基本类型Long String Integer
 * Float等数据类型封住了自己的实现了hadoop序列化接口的类型：LongWritable,Text,IntWritable,FloatWritable
 * 
 *
 */
